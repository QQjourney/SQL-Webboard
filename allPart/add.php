...
<body style="background-color: #20c997;">
    <nav class="navbar navbar-dark bg-success">
        ...
        <form  method="POST">
                    ...
                    <div class="container text-center mt-3">
                        <input type="text" placeholder="Blog Title" class="form-control my-3 bg-primary text-white text-center" name="title" required>
                ...
                <div class="col-12 col-lg-12 mt-3 my-3">
                    <div class="textarea-container">
                        <textarea name="content" class="form-control my-3 bg-light text-dark"  cols="30" rows="10" onfocus="setPlaceholder(this)" onblur="clearPlaceholder(this)" required></textarea>
                        <div class="placeholder  bg-white fs-5">Content</div>
                ...
                <select id="category" name="category" class="btn btn-warning dropdown-toggle btn-lg">
                    ...
                    <div>
                        <button class="btn btn-outline-success btn-lg" style="background-color: #555ca0; color: white;" name = "new_post">Add</button>
                    </div>
                </div>
        </form>
    ...
    <div class="cat">
      ...
      <div class="container-fluid text-center mt-2">
        <video class="mx-auto" width="100%" height="360" controls autoplay>
